...
export interface AnalysisEventDto { type: AnalysisEventType; message?: string; timestamp?: string; path?: string; diagnostic?: { timeoutType?: string; exitCode?: number | null; stderr?: string; modelId?: string; lastActivity?: string }; result?: PresentationKnowledgeBase; error?: string }
