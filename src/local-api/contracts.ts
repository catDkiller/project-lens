...
export type AnalysisFailureCode = 'provider-authentication-required' | 'free-quota-or-rate-limit' | 'model-unavailable' | 'network-or-provider-failure' | 'invalid-opencode-arguments' | 'permission-or-configuration-failure' | 'process-startup-failure' | 'parser-failure' | 'opencode-database-busy' | 'unknown'
