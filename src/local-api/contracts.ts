...
export interface ModelDto { providerId: string; modelId: string; fullId: string; displayName: string; availability: 'available'; free?: boolean; connected?: boolean; local?: boolean; variant?: string }
