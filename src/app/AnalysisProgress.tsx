...
export function AnalysisProgress({ projectName = 'project', modelId, events, startedAt = Date.now(), runState, lastAnyEventAt, lastGenuineAgentEventAt, cancelling = false, failed, onCancel, onRetry, onChooseModel, onConnectOpenCode }: AnalysisProgressProps) {
