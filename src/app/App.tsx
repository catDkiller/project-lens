...
export function App() {
  ...
  const [model, setModel] = useState<ModelChoice>(() => (localStorage.getItem('project-lens-codex-model') as ModelChoice | null) ?? 'gpt-5.4-mini')
  ...
  return <ReleaseLauncher state={state} onUsePrepared={usePrepared} onImportLocal={importLocal} onSourceReading={setReading} onSelectModel={(value) => { setModel(value); localStorage.setItem('project-lens-codex-model', value) }} onAnalyse={analyse} />
}
