...
export function App() {
  ...
  const [codex, setCodex] = useState<CodexStatusDto>(); const [token, setToken] = useState<string>(); const [local, setLocal] = useState<Local>(); const [prepared, setPrepared] = useState(false); const [reading, setReading] = useState(false)
