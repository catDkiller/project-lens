...
export function App() {
  ...
  return <main ref={root}>
    ...
    <div className="story" id="story">
      <section className="problem reveal"><p className="eyebrow">The problem</p><h2>Opening a repository is easy.<br /><em>Understanding how it works is not.</em></h2><p className="body-copy">A folder tree shows where files are stored. It does not explain where execution begins, how responsibilities connect, or what a new developer should inspect first.</p></section>
